...
class StockServiceTest {
     ...
     *                      데이터가 존재하기 때문에 실패를 리턴하게 되고 쓰레드 2 는 일정 시간 후에 Lock 획득을 위해 재시도 하게 되는 방식으로
     *                      쓰레드 1이 unLock 을 통해 Lock 을 해제하면 쓰레드 2 는 그 후에 Lock 획득 가능
     ...
     *          Lock 점유했던 것을 해제 했다고 알려주면 안내를 받은 쓰레드가 Lock 획득 시도를 하는 방식으로
